...
#define READ 1
#define WRITE 0
#define DELETE 2045 // 删除LPN的当前和历史数据
...
#define SR_D_C_A_TRANSFER 207
#define SR_D_DATA_TRANSFER 208
#define SR_D_TRANSFER 209
...
//	struct event_node *event;
	...
	struct sub_request *subs_d_head;     //channel上的删除请求队列头，新加进来的子请求加到队尾
	struct sub_request *subs_d_tail; 	 //channel上的删除请求队列尾，新加进来的子请求加到队尾
